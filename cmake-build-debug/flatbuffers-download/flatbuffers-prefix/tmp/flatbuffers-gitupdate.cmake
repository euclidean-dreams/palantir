...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6df40a2471737b27271bdd9b900ab5f3aec746c7"
  WORKING_DIRECTORY "/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/flatbuffers-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "6df40a2471737b27271bdd9b900ab5f3aec746c7")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("6df40a2471737b27271bdd9b900ab5f3aec746c7" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/6df40a2471737b27271bdd9b900ab5f3aec746c7")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/flatbuffers-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/flatbuffers-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
