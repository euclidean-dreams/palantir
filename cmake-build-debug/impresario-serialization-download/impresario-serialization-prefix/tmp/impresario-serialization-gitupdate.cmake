...
execute_process(
  COMMAND "/usr/bin/git" show-ref "origin/dev"
  WORKING_DIRECTORY "/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/impresario-serialization-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("origin/dev" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/origin/dev")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/impresario-serialization-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/josiah/projects/code/impresario-systems/palantir/cmake-build-debug/impresario-serialization-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
